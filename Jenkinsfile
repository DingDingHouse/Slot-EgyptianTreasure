...
pipeline {
    ...
    environment {
        PROJECT_PATH = "D:\\Slot-EgyptianTreasure"
    }
        ...
        stage('Checkout') {
            steps {
                script {
                    ...
                    git clone git@github.com:DingDingHouse/Slot-EgyptianTreasure.git D:\\Slot-EgyptianTreasure || echo "Repository already exists, pulling latest changes."
                    cd Slot-EgyptianTreasure
                    git checkout main
                    git fetch --all
